...
/* Video URL */
if (get_field('audio_upload')) { 
	$audiourl = get_field('audio_upload'); 
} else { 
...
<div class="<?php isotope_post(); ?> <?php get_category_slug(); ?> <?php span_size(); ?>">
	<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<!-- Audio -->
		<div data-audio-id="<?php echo $audioid; ?>" data-audio-url="<?php echo $audiourl; ?>" id="jquery_jplayer_<?php echo $audioid ?>" class="jp-jplayer"></div>
