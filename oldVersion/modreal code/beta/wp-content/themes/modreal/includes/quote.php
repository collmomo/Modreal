...
<div class="<?php isotope_post(); ?> <?php get_category_slug(); ?> <?php span_size(); ?>">
	<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<div class="entry-quote">
			<blockquote><p><?php if (get_field('the_quote')) { the_field('the_quote'); } else { echo "Place your awesome quote in the quote field in the post format settings box"; } ?></p></blockquote>
		</div>				 		
